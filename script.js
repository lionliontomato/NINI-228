...
const palette = [
  ['#ff7aa2','#fff0f5'],['#ff8fb1','#fff3f7'],['#f48fb1','#fff1f6'],
  ['#e879a3','#fff5f8'],['#ff9ebc','#fff0f4'],['#d96b9f','#fff4f8'],
  ['#f7a8c4','#fff6f9'],['#ff85aa','#fff1f5'],['#e89ab3','#fff5f7'],
  ['#f06f9f','#fff2f6'],['#c96b8f','#fff4f8'],['#ffb3c7','#fff7fa'],
  ['#e76f9e','#fff2f7'],['#f2a1b9','#fff6f8'],['#ff6f9f','#fff1f5']
];
